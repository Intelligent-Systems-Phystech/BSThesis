...
Применение алгоритма к новым данным выглядит следующим образом.
...
Базовым алгроритмом для выбора промежуточного пространства параметров является
