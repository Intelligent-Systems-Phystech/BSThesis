...
%	Веса с большим значением $\lambda$ имеют высокую плотность в нуле и могут быть удалены.	
	...
	\begin{figure}
	\includegraphics[width=5.55cm]{Pictures/lambda_D_I.pdf}
	\vspace{-0.45cm}
...
%	\hspace{-2cm}
	...
	\begin{figure}
%	\hspace{-2cm}
	\includegraphics[width=5.55cm]{Pictures/Portion_of_pruned_weights_on_lambda_D_I.pdf}
	\vspace{-0.45cm}	
%	\hspace{-2cm}
	...
	\begin{figure}
	\includegraphics[width=5.55cm]{Pictures/pruning_evidence_D_I.pdf}
	\vspace{-0.45cm}	
